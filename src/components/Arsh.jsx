        ...
        <div className="flex flex-col items-end ">
          ...
          >
            <span className="pr-3  text-[15px] md:text-[20px]">
              آدرس : آجودانیه مجتمع عرش آجودانیه طبقه اول
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div
            ...
            className="flex-row-center mt-5 text-white "
          >
            <span className="pr-3 text-[13px] md:text-[20px] ">
          ...
          >
            <span className="flex-row-center text-[13px] md:text-[20px] pr-3 text-white">
